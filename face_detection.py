...
def LoadData(): #载入训练数据集
    ...
    label = []
    num = 100
    path_cwd = "/Users/kim/PycharmProjects/csdn-test/dataset"
    for j in range(1,3):
...
if __name__ == '__main__':
    ...
    #cascade_path = cv2.CascadeClassifier(pathforcascade)
    #cascade_path = "haarcascade_frontalface_alt.xml"
    cascade_path = '/Users/kim/tensorflow-learn/haarcascade_frontalface_default.xml'
